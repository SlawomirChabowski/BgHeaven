...
<asp:Content ID="Content4" ContentPlaceHolderID="WebsiteContentPlaceHolder" runat="Server">
    ...
    <asp:SqlDataSource ID="UserListDataSource" runat="server" SelectCommand="SELECT [id], [name], [email], [last_active] FROM [t_user] WHERE ([rank] = 1)" ConnectionString="<%$ ConnectionStrings:ProkektConnectionString %>"></asp:SqlDataSource>
</asp:Content>
